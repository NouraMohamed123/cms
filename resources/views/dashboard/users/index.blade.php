...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        <ol class="breadcrumb breadcrumb-dot text-muted fs-6 fw-semibold">
            ...
            <li class="breadcrumb-item pe-3"><a href="#" class="pe-3 text-muted">المستخدمين</a></li>
            <li class="breadcrumb-item pe-3 text-primary">كل المستخدمين</li>
        </ol>
        <div class="d-flex">
            <form action="" class="d-flex">
                <select name="role_id" id="" class="form-select form-control w-200px me-2">
            ...
            @if(auth()->user()->hasPermission('users_create'))
                <a href="{{  route('dashboard.users.create') }}" class="btn btn-primary">اضافة  </a>
            @endif
