...
@section('content')
    <div class="container">
        ...
        <a href="{{ route('dashboard.coupons.create') }}" class="btn btn-primary mb-3">{{ trans('coupon.create_coupon') }} </a>


        <table class="table">
            <thead>
                <tr>
                    <th scope="col">{{ trans('coupon.code') }}</th>
                    <th scope="col">{{ trans('coupon.amount') }}</th>
                    <th scope="col">{{ trans('coupon.type') }}</th>
                    <th scope="col">{{ trans('coupon.usage_limit') }}</th>
                    <th scope="col">{{ trans('coupon.status') }}</th>
                    <th scope="col">{{ trans('coupon.Actions') }}</th>
                </tr>
            </thead>
            <tbody>
